...
const FavouritesPage = () => {
  ...
  if (favouriteItems.length === 0) {
    return (
      ...
      //     >
      //       <h1 className="text-2xl font-bold text-slate-900 mb-2">No favourites yet</h1>
      //       <p className="text-gray-600">Start browsing and save your favorite items here.</p>
      //     </motion.div>
      //     <motion.div
      //       initial={{ opacity: 0 }}
      //       animate={{ opacity: 1 }}
  ...
  return (
    ...
    //       <p className="text-gray-600">{favouriteItems.length} items saved</p>
    //     </div>
    //   </motion.div>
    ...
    //               className="h-8 w-8 bg-white/90 backdrop-blur-sm text-red-500 hover:bg-red-50 shadow-sm"
    //             >
    ...
    //               className="h-8 w-8 bg-white/90 backdrop-blur-sm hover:bg-slate-50 shadow-sm"
    //             >
    ...
    //           <div>
    //             <h3 className="font-semibold text-slate-900 mb-1">Love everything you see?</h3>
    //             <p className="text-gray-600 text-sm">Add all your favourite items to cart with one click.</p>
    //           </div>
    ...
    //       <p className="text-gray-600">Based on your favourite items</p>
    //     </div>
