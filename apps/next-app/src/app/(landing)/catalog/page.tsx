...
const CatalogPage = () => {
  ...
  return (
    // <div className="bg-gray-900 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    //   <div className="flex flex-col lg:flex-row gap-8">
    //     {/* Sidebar Filters */}
    //     <div className="lg:w-1/4 space-y-6">
    //       <div className="bg-gray-800 rounded-lg p-6 shadow-sm">
    //         <h3 className="text-lg text-white font-semibold mb-4 flex items-center">
    ...
    //             <Search size={20} className="absolute left-3 top-3 text-white" />
    //             <input
    //               type="text"
    //               placeholder="Search products..."
    //               value={searchTerm}
    //               onChange={(e) => setSearchTerm(e.target.value)}
    //               className="placeholder:text-gray-400 w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-500"
    //             />
    //           </div>
    //         </div>
    ...
    //                   className="w-4 h-4 text-white focus:ring-slate-500"
    //                 />
    ...
    //               <button
    //                 key={size}
    //                 className="py-2 px-3 border border-gray-300 rounded-lg text-sm hover:border-slate-500 text-gray-300 transition-colors"
    //               >
    //                 {size}
    //               </button>
    //             ))}
    ...
    //           <p className="text-white">{filteredProducts.length} items found</p>
    //         </div>
    ...
    //               className="appearance-none bg-gray-800 text-white border border-gray-300 rounded-lg px-4 py-2 pr-8 focus:outline-none focus:ring-2 focus:ring-slate-500"
    //             >
    ...
    //             </select>
    //             <ChevronDown size={16} className="absolute right-3 top-3 text-white pointer-events-none" />
    //           </div>
    //         </div>
    //       </div>
    ...
    //           <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 bg-gray-300 transition-colors">
    //             Previous
    //           </button>
    //           {[1, 2, 3, 4, 5].map((page) => (
    //             <button
    ...
    //                   : 'border-gray-300 hover:bg-gray-700 text-gray-400'
    //               }`}
    //             >
    //               {page}
    //             </button>
              ...
              <div className="grid grid-cols-3 gap-2">
                {['XS', 'S', 'M', 'L', 'XL', '2XL'].map((size) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="py-2 px-3 border border-gray-300 dark:border-gray-600 rounded-lg text-sm hover:border-blue-500 hover:bg-blue-500/10 transition-all text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
                  >
                    {size}
                  </motion.button>
                ))}
