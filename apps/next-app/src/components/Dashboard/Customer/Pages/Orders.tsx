      ...
      <div className="space-y-8">
        ...
        >
          <div className="relative">
            <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-black">My Orders</h1>
            <div className="h-1 w-16 bg-orange-500 mt-2 rounded-full"></div>
          </div>
          <p className="text-gray-600 mt-4 max-w-lg">Track and manage your orders</p>
        </motion.div>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-200">
                <CardContent className="p-6">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between">
                    <div
                      className={`p-3 rounded-full ${stat.bgColor} mt-3 sm:mt-0 flex items-center justify-center`}
                    >
                        ...
                        <TableRow key={order.id} className="border-gray-200">
                          ...
                          <TableCell>
                            {order.paymentStatus === 'Success'
                              ? formatDate(
                                  new Date(
                                    new Date(order.placedOn).setDate(
                                      new Date(order.placedOn).getDate() + 7
                                    )
                                  ).toISOString()
                                )
