      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <ul className="space-y-2">
              {['Help Center', 'Track Order', 'Privacy Policy', 'Terms of Service', 'FAQ'].map(
                (link) => (
                  <motion.li key={link} whileHover={{ x: 5 }}>
                    <a
                      href="#"
          ...
          >
            ...
            <div className="flex">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() =>
                  (window.location.href = `mailto:bshaw1352@gmail.com?subject=Hello from Zivelle`)
                }
        ...
        >
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            © 2025 Zivelle. All rights reserved. | Made with ❤️ by{' '}
